...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--pretrained_model', dest='pre_model', type=int, default=0)
    ...
    function_to_call(model=net, generated_data_path=args.data_path, images=args.images, labels=args.labels,
                     ...
                     sum_dir=args.summary_dir, batch_size=args.batch_size, lr=args.lr, log_after=args.log_after,
